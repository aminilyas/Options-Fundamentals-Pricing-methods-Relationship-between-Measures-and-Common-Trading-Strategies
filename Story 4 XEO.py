...
""
s0 = 1769.18      # the level of the SP500 index at the time of downloading the data on Dec 6 2022

# read the first files
fileName = inputPath+'/xeo_202212.xlsx'
call = pd.read_excel(fileName, 'call')
put = pd.read_excel(fileName, 'put')
# loop to read other files and append to these two files
for i in range(1,3):
    fileName = inputPath+'/xeo_20230'+str(i)+'.xlsx'
